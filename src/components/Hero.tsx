...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[10%] left-[-15%] w-[60vw] h-[60vw] rounded-full bg-herbal-soft/6 filter blur-[140px] pointer-events-none z-0" />
      <div className="absolute bottom-[5%] right-[-15%] w-[50vw] h-[50vw] rounded-full bg-sage/10 filter blur-[120px] pointer-events-none z-0" />

      {/* Parallax Background Graphic (Raw Ingredients watermark texture) */}
      <motion.div
        style={{ y: yBg, opacity: opacityHero }}
        className="absolute inset-0 w-full h-full opacity-[0.07] md:opacity-[0.10] pointer-events-none mix-blend-multiply z-0 select-none"
      >
        <Image
          src="/images/ayurvedic_raw_ingredients.png"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full h-full flex flex-col lg:flex-row items-center justify-between relative z-10 gap-12 lg:gap-8">
        ...
        <motion.div
          ...
          className="max-w-3xl text-left lg:pr-8 flex-1"
        >
          <div className="inline-flex items-center space-x-2 bg-sage/20 border border-sage/30 text-forest/90 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] mb-8 select-none">
            <span>Rooted in Ballari</span>
            <span className="w-1.5 h-1.5 bg-herbal-soft rounded-full" />
            <span>Serving Karnataka</span>
          </div>

          <h1 className="font-serif text-[48px] sm:text-[62px] md:text-[80px] lg:text-[90px] xl:text-[96px] font-bold tracking-tight text-forest leading-[1.04] mb-6">
            Rooted in Ayurveda.
            <br />
            <span className="text-earth font-light italic font-serif">Trusted</span> for Generations.
          </h1>

          <p className="font-sans text-base sm:text-lg md:text-xl text-forest/80 font-light leading-relaxed max-w-2xl mb-12">
          ...
          <div className="flex flex-row flex-wrap gap-4 items-center">
            ...
            <button
              ...
              className="group flex items-center space-x-2 bg-transparent text-forest hover:bg-sage/10 transition-all duration-300 px-8 py-4 rounded-full text-[10px] font-bold uppercase tracking-widest border border-forest/20"
            >
        ...
        >
          ...
          <div className="relative w-11/12 md:w-5/6 h-full bg-white/25 backdrop-blur-[12px] rounded-[2rem] border border-white/30 shadow-[0_12px_40px_rgba(61,90,64,0.04)] p-6 md:p-8 flex flex-col justify-between overflow-hidden group hover:border-sage/40 hover:shadow-[0_15px_50px_rgba(61,90,64,0.08)] transition-all duration-500">
            ...
            <div className="flex justify-between items-start select-none">
              <div>
                <p className="text-[9px] uppercase tracking-widest text-forest/50">Since 1980</p>
            ...
            <div className="flex justify-between items-end border-t border-sage/10 pt-4 select-none">
              <div>
                <p className="text-[8px] uppercase tracking-wider text-forest/50">Premium Sourcing</p>
                <p className="font-sans text-[11px] font-medium text-forest mt-0.5">Raw botanical herbs & roots</p>
              </div>
